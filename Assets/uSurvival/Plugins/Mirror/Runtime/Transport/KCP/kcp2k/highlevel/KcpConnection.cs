...
namespace kcp2k
{
    ...
    public abstract class KcpConnection
    {
        ...
        {
            // Initialize message with a default value to ensure it's always assigned
            message = default;
            ...
            if (msgSize > 0)
            {
                ...
                if (msgSize <= kcpMessageBuffer.Length)
                {
                    ...
                    else
                    {
                        ...
                        Disconnect();
                        // Assign a default value to message before returning
            ...
            header = KcpHeader.Disconnect;
            // message is already assigned to default at the start
            return false;
        }
